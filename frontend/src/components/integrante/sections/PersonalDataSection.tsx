  ...
  return (
    <div className="md:col-span-2">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <Input label="CPF" register={register('cpf')} error={errors.cpf?.message} readOnly={readOnly} />
        ...
        <Input label="RG" register={register('rg')} error={errors.rg?.message} readOnly={readOnly} />
      </div>
