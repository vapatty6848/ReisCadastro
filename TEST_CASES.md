...
| ID      | Caso de Teste              | Descrição                                                                 | Resultado Esperado                                                                |
| :------ | :------------------------- | :------------------------------------------------------------------------ | :-------------------------------------------------------------------------------- |
| CRUD-01 | Cadastro Completo          | Preencher todos os campos (Integrante, Responsável, Corporação) e salvar. | Integrante criado no banco, redirecionamento para listagem e mensagem de sucesso. |
| CRUD-02 | Cadastro com CPF Duplicado | Tentar cadastrar um integrante com um CPF já existente.                   | Mensagem de erro "CPF já cadastrado" vinda do backend.                            |
